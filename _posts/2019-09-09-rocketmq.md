...
由于NameServer之间相互独立，很明显，是一个AP设计（[关于CAP理论](https://qigangzhong.github.io/2019/07/28/rabbitmq/#cap%E5%8E%9F%E5%88%99base%E7%90%86%E8%AE%BA)）。
...
[RocketMQ高并发读写](https://cloud.tencent.com/developer/article/1615534)
...
[**rocketmq怎么保证队列完全顺序消费？ - 中间件兴趣圈的回答 - 知乎](https://www.zhihu.com/question/30195969/answer/1698410449)

[***RocketMQ系列之顺序消息原理解析（八）](https://www.shared-code.com/article/148)
...
>
> 5. 如果执行本地事务过程中，执行端挂掉，或者超时，Broker 将会不停的询问其同组的其他 producer 来获取状态(Broker调用producer检查本地事务的方法来检查producer本地事务状态)。
>
...
[RocketMQ：死信队列和消费幂等](https://blog.csdn.net/hqwang4/article/details/99980755)
...
[rocketmq如何保证消息不丢失](https://blog.csdn.net/leeasony/article/details/104857576)

[RocketMq-同步复制和异步复制](https://blog.csdn.net/ko0491/article/details/109763880)
...
[*****消息中间件—RocketMQ](https://www.jianshu.com/c/c1a9c08805ae)

[***图解RocketMQ消息发送和存储流程](https://juejin.cn/post/6844903862147497998)