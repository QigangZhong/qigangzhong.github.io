...
2. 下载[winutils.exe，hadoop.dll文件](https://codeload.github.com/srccodes/hadoop-common-2.2.0-bin/zip/master)，放入%HADOOP_HOME%\bin目录下面，将其中的hadoop.dll放入`C:\Windows\System32`中
