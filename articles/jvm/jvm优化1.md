...
需要特别说明的是：Metaspace所占用的内存空间不是在虚拟机内部，而是在本地内存空间中，这也是与1.7的永久代最大的区别所在。 
 	...
 	![1536507420882](assets.jvm1/1536507420882.png)
...
在最后面有OQL查询功能。
 ...
 ![1536513591638](assets.jvm1/1536513591638.png)
...
#### 4.5.3、使用
 ...
 ![1536515700264](assets.jvm1/1536515700264.png)

 ![1536515764096](assets.jvm1/1536515764096.png)

 ![1536515922938](assets.jvm1/1536515922938.png)

 ![1536516001249](assets.jvm1/1536516001249.png)

查看对象以及它的依赖： 

![1536516171924](assets.jvm1/1536516171924.png)

查看可能存在内存泄露的分析： ![1536516259369](assets.jvm1/1536516259369.png)
...
可以看到，当发生内存溢出时，会dump文件到java_pid5348.hprof。 ![1536591747657](assets.jvm1/1536591747657.png)
...
![1536594010544](assets.jvm1/1536594010544.png)
...
![1536654347046](assets.jvm1/1536654347046.png)

### 7.2、查看本地进程

 ![1536654611922](assets.jvm1/1536654611922.png)

### 7.3、查看CPU、内存、类、线程运行信息

 ![1536654708421](assets.jvm1/1536654708421.png)

### 7.4、查看线程详情

![1536654784904](assets.jvm1/1536654784904.png)

也可以点击右上角Dump按钮，将线程的信息导出，其实就是执行的jstack命令。

![1536656468818](assets.jvm1/1536656468818.png)
...
在一个主机下可能会有很多的jvm需要监控，所以接下来要在该主机上添加需要监控的jvm：
 ...
 ![1536681543452](assets.jvm1/1536681543452.png)
